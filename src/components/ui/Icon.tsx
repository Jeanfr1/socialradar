/** Inline stroke icons (24px grid). Decorative by default: pair with visible text. */
const PATHS = {
  "check-circle": (
    <>
  ...
  "alert-octagon": (
    <>
      <path d="M7.9 2.5h8.2l5.4 5.4v8.2l-5.4 5.4H7.9l-5.4-5.4V7.9Z" />
      <path d="M12 8v4" />
      <path d="M12 16h.01" />
    </>
  ),
  ...
  unlink: (
    <>
      <path d="m18.8 13.4 1.4-1.4a4.2 4.2 0 0 0-6-6l-1.4 1.4" />
      <path d="m5.2 10.6-1.4 1.4a4.2 4.2 0 0 0 6 6l1.4-1.4" />
